...
static const char *fonts[]          = { "ttf-dejavu:size=10" };
static const char dmenufont[]       = "ttf-dejavu:size=10";
...
static Key keys[] = {
	...
	{ 0,			   XF86XK_MonBrightnessDown, spawn, {.v = minus }},
	{ 0, 			   XF86XK_MonBrightnessUp,   spawn, {.v = plus }},
	{ ControlMask|ShiftMask,	XK_3,	   spawn,	   {.v = maim	}  },
	{ ControlMask|ShiftMask,	XK_4,	   spawn,	   {.v = flameshot }},
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ ControlMask,			XK_space,  spawn,	   {.v = rofi } },
	{ ControlMask,             	XK_Return, spawn,          {.v = termcmd } },
	{ Mod1Mask,			XK_x,	   spawn,	   {.v = firefox } },
